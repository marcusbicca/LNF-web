...
export function deUltimoExecutar(
  ...
  // A resposta pode vir embrulhada: a coluna 'resultado' da tabela de
  // respostas guarda o corpo da pipe, e algumas telas guardam { resultado: {...} }.
  const r = raiz.PedidosDict || raiz.Nfs ? raiz : obj(raiz.resultado ?? raiz.Resultado)
